...
export const ExecutionGallery: React.FC<
  ExecutionGalleryProps
> = ({
  project,
  language,
}) => {
  ...
  const activeStageData =
    activeStage !== null &&
    project.executionPhotos
      ? project.executionPhotos[activeStage] ?? null
      : null;
  ...
  const activeImages = useMemo(() => {
    ...
    return getImages(activeStageData);
  }, [activeStageData]);
   ...
   *
   * IMPORTANT:
   * The modal is rendered through createPortal().
   * This prevents it from being trapped inside the
   * section's stacking / overflow context.
   * =========================================================
   */
