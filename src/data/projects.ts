...
export const projects: Project[] = [
  {
    ...
    details: [
      ...
      {
        id: "sv-d2",
        title: "Door and parking lot implementation details",
  ...
  },
  {
    ...
    lightSectionTitleEn: "Visual Identity",
    lightSectionTitleFa: "هویت بصری",
    lightNarrativeEn: "Commercial MDF Showroom in Mazandaran; a contemporary architectural design emphasizing visual identity and the customer's spatial experience.",
    lightNarrativeFa: "پروژه تجاری فروشگاه MDF در مازندران؛ تجلی معماری مدرن با تأکید بر هویت بصری و تجربه فضایی مشتری.",
