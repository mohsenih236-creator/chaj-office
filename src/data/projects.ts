...
export const projects: Project[] = [
  ...
  },
  {
    ...
    lightSectionTitleEn: "Transparent façades, natural daylight, and the continuity of the landscape toward the interior soften the boundary between inside and outside, creating a home where nature, light, and rain become an integral part of the architecture.",
    lightSectionTitleFa: "شفافیت جداره‌ها، نور طبیعی و امتداد فضای سبز تا آستانه‌ی بنا، مرز میان داخل و خارج را کم‌رنگ کرده و فضایی ساخته است که طبیعت، نور و باران بخشی از معماری آن هستند.",
    lightNarrativeEn: "The pitched roofs are designed not merely as a functional response to the region’s rainfall, but as an architectural element that brings the sound and presence of rain into the living experience. The design allows residents to sit comfortably inside, watching and listening to the gentle rhythm of rain falling outside.",
    lightNarrativeFa: "سقف‌های شیب‌دار پروژه با نگاهی فراتر از یک پاسخ عملکردی به بارندگی، به‌گونه‌ای طراحی شده‌اند که صدای باران و حرکت آن را به تجربه‌ای ملموس در فضای داخلی تبدیل کنند؛ تا ساکنان بتوانند در آرامش خانه بنشینند و شرشر باران را تماشا و گوش کنند.",
